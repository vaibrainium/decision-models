...
class OptimizedDecisionModel:
    ...
    def _setup_parameter_bounds(self) -> dict[str, tuple[float, tuple[float, float]]]:
        ...
        bounds = {
            ...
            "ndt_1": (0.2, (0.1, 0.5)),
            "drift_gain_1": (7.0, (1.0, 20.0)),
            "variance_1": (1.0, (0.1, 5.0)),
            # Prior condition 2 (unequal) parameters
            "a_2": (2.0, (0.8, 6.0)),
            "z_2": (0.5, (0.1, 0.9)),
            "drift_offset_2": (0.0, (-5.0, 5.0)),
            "ndt_2": (0.2, (0.1, 0.5)),
            "drift_gain_2": (7.0, (1.0, 20.0)),
            "variance_2": (1.0, (0.1, 5.0)),
        }

        if self.enable_leak:
            bounds["leak_rate_1"] = (0.1, (0.0, 1.0))
            bounds["leak_rate_2"] = (0.1, (0.0, 1.0))

        if self.enable_time_dependence:
            bounds["time_constant_1"] = (0.01, (0.001, 0.1))
            bounds["time_constant_2"] = (0.01, (0.001, 0.1))
